      ...
      <div className={styles.left}>
        <div className={styles.calender}>
          <div className={styles.cal}>
            ...
            >
              <path
                ...
                stroke={theme === 'dark' ? 'black' : '#34caa5'}
                strokeWidth='1.37144'
              />
              <path
          ...
          <svg
            ...
            style={
              theme === 'dark'
                ? { borderRadius: '50%', border: '1px solid #dadddd' }
                : { borderRadius: '50%', border: '1px solid #34caa5' }
            }
          >
            <path
              fillRule='evenodd'
