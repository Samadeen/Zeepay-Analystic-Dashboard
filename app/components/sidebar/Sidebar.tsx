...
const Sidebar = () => {
  ...
  const lightSwitchHandler = () => {
    setSwitcher((prevState) => (prevState === 'dark' ? 'light' : 'dark'));
    toggleTheme();
  };
  const darkSwitchHandler = () => {
    setSwitcher((prevState) => (prevState === 'light' ? 'dark' : 'light'));
    toggleTheme();
  };
      ...
      <ul>
        ...
        <li className={styles.theme}>
          ...
          <svg
            ...
            className={`${switcher === 'light' ? styles.background : ''}`}
          >
            <g clip-path='url(#clip0_1826_464)'>
              <path
                ...
                fill={switcher === 'light' ? 'white' : '#b2abab'}
              />
              <path
          ...
          <svg
            ...
            viewBox='0 0 30 30'
            fill='none'
            onClick={darkSwitchHandler}
            className={`${switcher === 'dark' ? styles.background : ''}`}
          >
            <path
